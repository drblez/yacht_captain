...
\usepackage{extdash}
\usepackage[xindy,truexindy]{imakeidx}
\usepackage{wrapfig}
...
\makeindex[
  options= -M yacht_captain -L russian -C utf8 -v -t yacht_captain.xindy.log
]
...
\newcommand{\picsource}[1]{\href{#1}{Источник}}
\newcommand{\CCBYSA}[1]{\href{https://creativecommons.org/licenses/by-sa/3.0/}{CC BY-SA #1.0}}
