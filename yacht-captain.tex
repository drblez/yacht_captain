...
% This package gives the enumerate environment an optional argument which
...
\newcommand{\coord}[2]{\ensuremath{#1\gr#2'}}
...
\newcommand{\keyDiv}{\fbox{$\div$}\xspace}
\newcommand{\keyMul}{\fbox{$\times$}\xspace}
\newcommand{\keyPlus}{\fbox{+}\xspace}
\newcommand{\keyMinus}{\fbox{$-$}\xspace}
\newcommand{\keyF}[1]{\fbox{\texttt{F}}\space\fbox{\texttt{#1}}\xspace}
\newcommand{\keyEq}{\fbox{=}\xspace}
\newcommand{\lcdD}[1]{\textLCD{10}|#1|}
